...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-green-700 opacity-95"></div>
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center mb-6">
                <div className="relative">
                  <img src={logo} alt="Nogma.H Enterprise Logo" className="w-16 h-16 rounded-2xl shadow-lg border-4 border-yellow-400" />
            ...
            <div className="lg:col-span-1 font-Roboto">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="leading-relaxed">
                  <h5 className="text-yellow-400 font-semibold mb-3">Products</h5>
                  <ul className="space-y-2">
                    <li><Link to="/all-product" className="text-gray-300 hover:text-yellow-400 transition-colors text-sm">All Products</Link></li>
                    <li><Link to="/product-detail?id=1" className="text-gray-300 hover:text-yellow-400 transition-colors text-sm">Shea Butter</Link></li>
                    <li><Link to="/product-detail?id=4" className="text-gray-300 hover:text-yellow-400 transition-colors text-sm">Groundnut Paste</Link></li>
                    <li><Link to="/product-detail?id=13" className="text-gray-300 hover:text-yellow-400 transition-colors text-sm">Tom Brown</Link></li>
                  </ul>
                </div>
                <div>
                  <h5 className="text-yellow-400 font-semibold mb-3">Company</h5>
                  <ul className="space-y-2 leading-relaxed">
                    <li><Link to="/about" className="text-gray-300 hover:text-yellow-400 transition-colors text-sm">Our Story</Link></li>
                    <li><Link to="/blog" className="text-gray-300 hover:text-yellow-400 transition-colors text-sm">Blog</Link></li>
            ...
            <div className="lg:col-span-1 font-Outfit">
              ...
              <div className="space-y-4 font-Outfit">
                <div className="flex items-center space-x-3 ">
                  ...
                  <div>
                    <a href="https://maps.google.com/?q=Tamale,Ghana" target="_blank" rel="noopener noreferrer" className="text-white font-semibold hover:text-yellow-400 transition-colors cursor-pointer">Tamale, Ghana</a>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <a href="tel:+233505944839" className="text-white font-semibold hover:text-yellow-400 transition-colors cursor-pointer">+233 50 594 4839</a>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <a href="mailto:akunyarahelenakunyara@gmail.com" className="text-white font-semibold hover:text-yellow-400 transition-colors cursor-pointer">akunyarahelenakunyara@gmail.com</a>
