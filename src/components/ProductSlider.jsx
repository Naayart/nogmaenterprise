          ...
          >
            ...
            <div className="w-full flex items-center justify-center pt-6 pb-3 px-4">
              <img
                src={product.image}
                alt={product.name}
                className="object-contain w-full h-36 md:h-44 lg:h-52 rounded-xl transition-transform duration-300 transform group-hover:scale-105"
              />
            </div>

            {/* Product Info */}
            <div className="w-full px-5 pb-5 flex flex-col items-center">
              <div className="text-xs text-green-700 mb-1 uppercase tracking-wide font-semibold opacity-70">
                {product.category}
              </div>
              <div className="font-bold text-lg text-black text-center truncate mb-1">
                {product.name}
              </div>
