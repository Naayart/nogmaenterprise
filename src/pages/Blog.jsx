...
export const blogPosts = [
  {
    ...
    excerpt:
      "Discover the traditional process of harvesting and processing shea butter in northern Ghana, and how Nogma.H Enterprise maintains these age-old techniques while ensuring modern quality standards.",
    content:
      "Shea butter has been a cornerstone of Ghanaian beauty and wellness traditions for centuries. At Nogma.H Enterprise, we take pride in preserving these traditional methods while ensuring our products meet the highest quality standards. Our shea butter is harvested from wild shea trees in the northern regions of Ghana, where the climate and soil conditions create the perfect environment for producing premium-grade shea nuts...",
    author: "Helen Akunyanra",
    date: "2024-01-15",
    category: "Product Stories",
    readTime: "5 min read",
    image:
      "https://media.istockphoto.com/id/2176675162/photo/shea-nuts.webp?a=1&b=1&s=612x612&w=0&k=20&c=8rT7Vz0Tu7cNNV79hSSYtqOyNN3JgkZsUtTPG8K5TTg=",
  ...
  },
  {
    ...
    excerpt:
      "Learn about our comprehensive training program that has empowered over 5,000 women in the Tolon District with valuable skills in soap production and entrepreneurship.",
    content:
    ...
    readTime: "7 min read",
    image:
      "https://images.unsplash.com/photo-1509100226070-1744f3cd5642?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHNvYXAlMjBtYWtpbmclMjB3aXRoJTIwYSUyMGJsYWNrJTIwd29tZW58ZW58MHx8MHx8fDA%3D",
  ...
  },
  {
    ...
    excerpt:
      "Explore the nutritional benefits of groundnut paste and how this traditional Ghanaian food staple contributes to healthy living and sustainable nutrition.",
    content:
      "Groundnut paste, also known as peanut butter in some regions, is more than just a delicious spread - it's a nutritional powerhouse that has been part of Ghanaian diets for generations. Rich in protein, healthy fats, and essential vitamins, our groundnut paste is made from carefully selected peanuts grown in the fertile soils of northern Ghana...",
    author: "Helen Akunyanra",
    date: "2024-01-05",
    category: "Health & Wellness",
    readTime: "4 min read",
    image:
      "https://cdn.pixabay.com/photo/2024/07/01/04/15/ai-generated-8864296_960_720.png",
  ...
  },
  {
    ...
    excerpt:
      "Follow the inspiring journey of how a simple dream in northern Ghana grew into a thriving enterprise that empowers thousands of women and serves communities across Ghana.",
    content:
      "Every great enterprise begins with a dream, and Nogma.H Enterprise is no exception. What started as a vision in 2019 has grown into a thriving business that not only produces quality products but also creates opportunities for community development. The journey hasn't been without challenges, but through determination, community support, and unwavering commitment to quality, we've built something truly special...",
    author: "Helen Akunyanra",
    date: "2023-12-28",
    category: "Company Story",
    readTime: "8 min read",
    image:
      "https://images.unsplash.com/photo-1655720357872-ce227e4164ba?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YWZyaWNhbiUyMHdvbWVuJTIwaW4lMjBhJTIwbWVldGluZ3xlbnwwfHwwfHx8MA%3D%3D",
    tags: ["Entrepreneurship", "Success Story", "Community"],
  },
  {
    id: 5,
    title:
      "Sustainable Production: Our Commitment to Environmental Responsibility",
    excerpt:
      "Discover how Nogma.H Enterprise implements sustainable practices in our production processes, from sourcing raw materials to packaging and waste management.",
    content:
      "At Nogma.H Enterprise, we believe that business success and environmental responsibility go hand in hand. Our commitment to sustainable production practices is reflected in every aspect of our operations, from the way we source our raw materials to how we package and distribute our products. We work closely with local farmers who practice sustainable agriculture, ensuring that our ingredients are not only of the highest quality but also produced in ways that protect our environment for future generations...",
    author: "Helen Akunyanra",
    date: "2023-12-20",
    category: "Sustainability",
    readTime: "6 min read",
    image:
      "https://images.unsplash.com/photo-1585962485475-e411a40a1a6b?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    excerpt:
      "Learn about the traditional Ghanaian breakfast staple, Tom Brown, and how our version combines traditional recipes with modern nutritional science for optimal health benefits.",
    content:
      "Tom Brown is more than just a breakfast cereal - it's a cultural institution in Ghana that has been nourishing families for generations. Our Tom Brown is made from carefully selected maize, groundnuts, and other nutritious ingredients, all sourced from local farmers. The traditional preparation methods we use ensure that all the natural nutrients are preserved, making it an excellent choice for a healthy start to your day...",
    author: "Helen Akunyanra",
    date: "2023-12-15",
    category: "Product Stories",
    readTime: "5 min read",
    image:
      "https://africangoodsmarket.shop/cdn/shop/files/koko2_c92a9392-de8c-4686-a61c-e62b72d381c9.png?v=1713884341&width=1946",
      ...
      <div className="bg-[url(https://cdn.pixabay.com/photo/2021/08/30/18/40/paprika-6586748_960_720.jpg)] bg-cover bg-center bg-no-repeat py-24 pt-28 mt-15 relative">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-2xl text-[#F5F5DC] font-medium max-w-3xl mx-auto leading-relaxed font-Playfair">
            Stories of empowerment, community impact, and the journey of Nogma.H
            Enterprise
          </p>
        </div>
      </div>
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-12">
              <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md mx-auto">
                ...
                <h3 className="text-xl font-bold text-[#046404] mb-2">
                  No articles found
                </h3>
