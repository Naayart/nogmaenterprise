    ...
    return (
      <>
        ...
        <div className="min-h-screen flex flex-col items-center justify-center">
          ...
          <button onClick={() => navigate("/blog")} className="bg-[#046404] text-white px-6 py-2 rounded">Back to Blog</button>
        </div>
        <Footer />
      </>
    );
    ...
    <>
      ...
      <div className="bg-gradient-to-b from-white to-gray-50 min-h-screen pt-24 pb-12">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 mt-8">
          <button onClick={() => navigate("/blog")} className="mb-4 text-[#046404] hover:underline">← Back to Blog</button>
          ...
          <h1 className="text-3xl font-bold text-[#046404] mb-4">{post.title}</h1>
